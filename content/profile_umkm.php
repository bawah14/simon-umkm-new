<?php //var_dump($_GET)
$profile = $db->manual_query("select * from umkm left join perizinan on umkm.id_umkm = perizinan.id_umkm where umkm.id_umkm = ".$_GET['id_umkm'])[0];
// var_dump($profile);
	...
	<div class="col-12">
		<div class="card card-widget widget-user">
          ...
          <div class="widget-user-header bg-info">
            <h3 class="widget-user-username"><?php echo $profile['nama_umkm'] ?></h3>
          ...
          <div class="card-body">
          	<div class="row">
          		<div class="col-lg-6 col-sm-12">
                      ...
                      <button class="btn btn-info" data-toggle="modal" data-target="#modal-tandatangan">Sign</button>
          					</div>
          				</div>
          				<div class="card-body">
          					<div class="col-12">
          						...
          						<?php foreach ($profile as $key => $value): ?>
          							<?php if (!is_numeric($key) && ($key !="id_umkm") && ($key !="id_umkm") && ($key !="foto_pemilik_umkm") && ($key !="foto_ktp_pemilik_umkm") ): ?>
	          						<tr>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="php/perizinan.php" enctype="multipart/form-data">
          <input type="hidden" name="id_umkm" value="<?php echo $profile['id_umkm'] ?>">
          <input type="hidden" name="insert" >
          <div class="row">
            <div class="col-12">
              <div class="form-group">
