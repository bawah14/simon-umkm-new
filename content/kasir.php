								...
								<div class="row">
										...
										<div class="form-group">
											...
											<select class="form-control select2" name="id_produk" id="id_produk">
												...
												<?php foreach ($produk as $key => $value): ?>
													<option value="<?php echo $value['id_produk'] ?>" ><?php echo $value['id_produk'] ?> - <?php echo $value['nama_produk']." - ".$value['nama_umkm']." - ".$value['harga_produk'] ?> </option>
												<?php endforeach ?>
											</select>
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
											...
											<input type="text" class="form-control" name="nama_produk" readonly="" id="nama_produk">
										</div>
									</div>
									<div class="col-lg-2">
										<div class="form-group">
