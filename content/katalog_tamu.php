							...
							<?php foreach ($v as $key => $value): $count++; ?>
								<div class="col-lg-2 col-6 col-md-2 col-sm-4 float-left">
									<div class="card" id="card-<?php echo $value['id_produk'] ?>">
										<div  style="height: 150px;width: 150px;text-align: center" class="clickable center" role="button" data-toggle="modal" data-target="#produk-<?php echo $value['id_produk'] ?>">	
											<?php if ($value['foto_produk'] != "" && file_exists("php/images/produk/".$value['foto_produk'])): ?>
											  <img style="width: 100%;height: 100%;display:flex;justify-content: center;align-items: center;margin:auto;" src="php/images/produk/<?php echo $value['foto_produk'] ?>" loading="lazy" alt="Avatar"  >
											
											<?php else: ?>
											  <img style="width: 100%;height: 100%;display:block;margin:auto;" src="dist/img/default-150x150.png" alt="Avatar"  >
