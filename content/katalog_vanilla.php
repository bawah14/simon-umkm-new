			...
			<div class="card-header">
				...
				<div class="card-body">
	                <div id="accordion">
	                  ...
	                  <?php foreach ($newproduk as $k => $v): ?>
	                  <?php $acc = str_replace(" ", "_", $k) ?>	
	                  <div class="card card-primary">
	                    <div class="card-header clickable" data-toggle="collapse" data-parent="#accordion" href="#<?php echo $acc ?>">
	                      <h4 class="card-title">
	                        <a >
	                          <?php echo $k ?>
	                        </a>
	                    ...
	                    <div id="<?php echo $acc ?>" class="panel-collapse collapse in">
	                      <div class="card-body">
	                        <?php $count = 0; ?>
							<div class="row">
							<?php foreach ($v as $key => $value): $count++; ?>
								<div class="col-lg-2 col-6 col-md-2 col-sm-4 float-left">
									<div class="card" id="card-<?php echo $value['id_produk'] ?>">
										<div class="clickable center" role="button" data-toggle="modal" data-target="#produk-<?php echo $value['id_produk'] ?>">	
											<?php if ($value['foto_produk'] != ""): ?>
											  <img style="max-height: 150px;max-width: 150px;display:flex;justify-content: center;align-items: center;margin:auto;" src="php/images/produk/<?php echo $value['foto_produk'] ?>" loading="lazy" alt="Avatar"  >
											
											<?php else: ?>
											  <img style="max-height: 150px;max-width: 150px;display:block;margin:auto;" src="dist/img/default-150x150.png" alt="Avatar"  >
												
											<?php endif ?>
										</div>
										  <div class="container">
										    <b class="nama_produk" id="nama-<?php echo $value['id_produk'] ?>"><?php echo $value['nama_produk'] ?></b>
  ...
  <div class="modal-dialog modal-lg" role="document">
    <div class="modal-content">
      		...
      		<div class="col-lg-4 col-12">
      			...
      			<div class="input-group">
      				<div class="input-group-prepend">
	                    <button class="btn btn-default min" value="<?php echo $value['id_produk'] ?>">-</button>
	                </div>
      				<input type="number" style="text-align-last: center" id="jmlh-<?php echo $value['id_produk'] ?>" class="form-control" name="jumlah_produk" value="0" readonly >
      				<div class="input-group-append">
	                    <button class="btn btn-default plus" value="<?php echo $value['id_produk'] ?>">+</button>
	                </div>
      			</div>
      		</div>
      	</div>
      ...
      <div class="modal-footer">
        ...
        <button type="button" class="btn btn-primary trigger-cart" value="<?php echo $value['id_produk'] ?>"  ><i class="fa fa-cart-plus"></i> Tambahkan </button>
